        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    ImageName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IntroductionImageName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    IntroductionText = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    EnglishName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Info1 = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    Info2 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    UrlAddress = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    ...
                    ConsumptionInstruction = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HowMaintain = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RecommendationsAndWarningsAsJson = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    PropertiesListAsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CompoundsAsJson = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
